...
public class AreaJsonController {
	...
	@RequestMapping(value = "getAreaListByCityId")
	@ResponseBody
	public Object getAreaListByCityId(@RequestParam("cityId") Integer cityId) {
		return messageDao.getMessage(stockService.getAreaListByCityId(cityId));
	}
}
